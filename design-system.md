...
papel"): cuatro tonos pastel adicionales, exclusivos para esta función, que NO reemplazan ni
se mezclan con `primary`/`alert`/`success` de arriba (cada uno de esos tres ya tiene un
...
Mismo criterio que el resto de la paleta: solo fondo/borde, nunca color de texto directo.
